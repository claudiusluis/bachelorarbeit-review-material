# Supplementäre Materialien zur Bachelorarbeit

Dieses Repository enthält ergänzende Materialien zur Bachelorarbeit:
...
Der Ordner `data/` enthält Datendateien, die im Rahmen des systematischen Reviews erstellt oder verwendet wurden.

- `screening_databases.csv`  
  Tabelle mit den identifizierten und gescreenten Studien aus der Literaturrecherche.

---

## Skripte

Der Ordner `scripts/` enthält Python-Skripte zur Datenaufbereitung und zur Erstellung von Tabellen für die Bachelorarbeit.

Beispiele:

- Erstellung von Tabellen zu  
  - Kraftparametern  
  - Powerparametern  
  - Studien- und Populationseigenschaften  
  - Trainingsinterventionen und Trainingsreihenfolgen
...
- Entscheidungsbaum für Ein- und Ausschlusskriterien
